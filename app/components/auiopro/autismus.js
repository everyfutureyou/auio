    ...
    return (
      <div>
        <div className="paperStyle" id="autismus">
          ...
          <p>Auf der Plattform wird ein eigener Themenbereich eingerichtet, der sich dieser Frage ausführlich widmet. So können wir für unterschiedliche Wissensstände die passenden Informationen bereitstellen.</p>
        </div>
      </div>
    );
  }
